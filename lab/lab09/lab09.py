...
def subseqs(s):
    ...
    if s == []:
        ...
        rest = subseqs(s[1:])
        return rest + insert_into_all(s[0], rest) # insert s[0] or not 
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    # num_trees(i) represents the number of trees on the left side
    # num_trees(n - i) represents the number of trees on the right side
